...
public class SkyRenderer extends IRenderHandler {
	...
	{
		if (mc.theWorld.provider.dimensionId == Virtious.dimensionID)
        {
			
			float f18 = world.getStarBrightness(partialTicks) * (1.0F - world.getRainStrength(partialTicks));//sky opacity
...
//            tessellator.setColorOpaque_I(2631720); //only for end sky
