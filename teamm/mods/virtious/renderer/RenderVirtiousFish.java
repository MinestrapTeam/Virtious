...
public class RenderVirtiousFish extends Render
{
     ...
     */
    public void doRenderFishHook(EntityVirtiousFishHook par1EntityFishHook, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation func_110791_a(EntityVirtiousFishHook par1Entity)
    {
    ...
    {
        return this.func_110791_a((EntityVirtiousFishHook)par1Entity);
    }
    ...
    {
        this.doRenderFishHook((EntityVirtiousFishHook)par1Entity, par2, par4, par6, par8, par9);
    }
}
