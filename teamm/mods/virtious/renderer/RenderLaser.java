...
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("virtious:textures/models/Laser.png");

    public void renderArrow(EntityLaser par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
