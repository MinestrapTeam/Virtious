...
public class BlockCytoidDoor extends Block
{
    ...
    public BlockCytoidDoor(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon("virtious:CytoidDoorTop");
        this.field_111043_b[0] = par1IconRegister.registerIcon("Virtious:CytoidDoorBottom");
    ...
    {
    	return VirtiousItems.cytoidDoor.itemID;
    }
