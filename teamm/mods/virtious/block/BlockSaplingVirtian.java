...
import teamm.mods.virtious.world.gen.VirtiousGenVirtianTree;
...
public class BlockSaplingVirtian extends VirtiousFlower
{
...
//    private Icon[] saplingIcon;
    ...
    public BlockSaplingVirtian(int par1)
    {
        super(par1);
        float f = 0.4F;
...
//    }
    ...
    public void growTree(World world, int i, int j, int k, Random rand)
    {
        ...
        VirtiousGenVirtianTree fostimber = new VirtiousGenVirtianTree(VirtiousBlocks.leavesVirtian.blockID, VirtiousBlocks.logVirtian.blockID, true);
