...
public class VirtiousGenMinable extends WorldGenerator
{
    ...
    public VirtiousGenMinable(int par1, int par2)
    {
        this(par1, par2, VirtiousBlocks.virtianstone.blockID);
    }

    public VirtiousGenMinable(int par1, int par2, int par3)
    {
    ...
    public VirtiousGenMinable(int id, int meta, int number, int target)
    {
