...
public class VRecipes
{
	public static void load()
	{
		...
		ItemStack virtianwoodPlanks = new ItemStack(VBlocks.virtious_planks, 0, 4);
		ItemStack amberwoodPlanks = new ItemStack(VBlocks.virtious_planks, 1, 4);
		
		GameRegistry.addRecipe(new ItemStack(Blocks.furnace), new Object[] { "SSS", "S S", "SSS", Character.valueOf('S'), VBlocks.virtianstone_cobbled });
		...
		//
		GameRegistry.addRecipe(new ItemStack(VBlocks.virtianstone, 4), new Object[] { "S", Character.valueOf('S'), VBlocks.virtianstone_bricks });
		...
		GameRegistry.addRecipe(new ItemStack(VBlocks.deepstone, 1), new Object[] { "S", Character.valueOf('S'), VBlocks.deepstone_bricks });
		GameRegistry.addRecipe(new ItemStack(VBlocks.canyonstone, 1), new Object[] { "S", Character.valueOf('S'), VBlocks.canyonstone_bricks });
		//
		...
		GameRegistry.addShapelessRecipe(new ItemStack(VItems.vois_food, 1), new ItemStack(VItems.burhaunch_cooked, 1), new ItemStack(VItems.veer_dye, 1));// FIXME
