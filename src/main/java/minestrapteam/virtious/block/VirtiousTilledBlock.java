...
public class VirtiousTilledBlock extends VirtiousBlock
{
    ...
    public VirtiousTilledBlock(int par1)
    {
    ...
    {
        return par1 == 1 ? (par2 > 0 ? this.wet : this.dry) : VirtiousBlocks.virtianSoil.getBlockTextureFromSide(par1);
    }
    ...
    {
        return VirtiousBlocks.virtianSoil.idDropped(0, par2Random, par3);
    }
    ...
    {
        return VirtiousBlocks.virtianSoil.blockID;
    }
    ...
    public boolean canSustainPlant(World world, int x, int y, int z, ForgeDirection direction, IPlantable plant)
    {
        ...
        if (plantID == VirtiousBlocks.plantVeer.blockID)
        {
            return true;
        }
        return false;
    ...
    {
        this.wet = iconRegister.registerIcon("virtious:TilledVirtianSoilWet");
        this.dry = iconRegister.registerIcon("virtious:TilledVirtianSoilDry");
    }
}