...
public class BlockLogVirtian extends VirtiousBlock
{
	...
	public BlockLogVirtian(int id, Material mat)
	{
		super(id, mat);
	}
	...
	{
		this.iconTop = par1IconRegister.registerIcon("virtious:VirtianwoodTop");
		this.iconSide = par1IconRegister.registerIcon("virtious:VirtianwoodSide");
	}
