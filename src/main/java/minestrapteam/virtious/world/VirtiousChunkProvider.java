...
import minestrapteam.virtious.block.VirtiousBlock;
import minestrapteam.virtious.lib.VirtiousBlocks;
import minestrapteam.virtious.world.gen.VirtiousGenVirtiousLakes;
...
public class VirtiousChunkProvider extends ChunkProviderGenerate
{
...
//        ravineGenerator = TerrainGen.getModdedMapGen(ravineGenerator, RAVINE);
    ...
    public VirtiousChunkProvider(World par1World, long par2, boolean par4)
    {
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == (byte)VirtiousBlocks.virtianstone.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)VirtiousBlocks.virtianstone.blockID;
                                }
