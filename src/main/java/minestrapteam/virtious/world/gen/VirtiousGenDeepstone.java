...
public class VirtiousGenDeepstone extends WorldGenerator
{
    ...
    public VirtiousGenDeepstone(int par1, int par2)
    {
        this(par1, par2, VirtiousBlocks.deepStone.blockID);
    }

    public VirtiousGenDeepstone(int par1, int par2, int par3)
    {
    ...
    public VirtiousGenDeepstone(int id, int meta, int number, int target)
    {
