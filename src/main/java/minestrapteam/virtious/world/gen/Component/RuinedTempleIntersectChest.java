...
public class RuinedTempleIntersectChest extends WorldGenerator
{
	...
	public RuinedTempleIntersectChest() { }
...
//		}
		...
		world.setBlockMetadataWithNotify(i + 2, j + 1, k + 2, Block.chest.blockID, 3);
