...
public class RuinedTempleHallBroken extends WorldGenerator
{
...
//		}
		...
		world.setBlock(i + 1, j + 3, k + 4, Block.fenceIron.blockID);
		world.setBlock(i + 1, j + 4, k + 0, Block.stone.blockID);
		world.setBlock(i + 1, j + 4, k + 1, Block.stoneBrick.blockID);
		world.setBlock(i + 1, j + 4, k + 2, Block.fenceIron.blockID);
		...
		world.setBlock(i + 3, j + 3, k + 0, Block.fenceIron.blockID);
		...
		world.setBlock(i + 3, j + 4, k + 3, Block.fenceIron.blockID);
		...
		world.setBlock(i + 4, j + 3, k + 0, Block.fenceIron.blockID);
