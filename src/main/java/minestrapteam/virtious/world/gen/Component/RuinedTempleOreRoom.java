...
//		}
		...
		world.setBlock(i + 0, j + 3, k + 2, Block.oreGold.blockID);
		...
		world.setBlock(i + 1, j + 1, k + 0, Block.oreGold.blockID);
		world.setBlock(i + 1, j + 1, k + 3, Block.oreGold.blockID);
		...
		world.setBlock(i + 2, j + 1, k + 1, Block.oreGold.blockID);
		...
		world.setBlock(i + 3, j + 1, k + 2, Block.oreGold.blockID);
		world.setBlock(i + 3, j + 2, k + 0, Block.stone.blockID);
		world.setBlock(i + 3, j + 3, k + 0, Block.oreGold.blockID);
		...
		world.setBlock(i + 4, j + 2, k + 2, Block.oreGold.blockID);
		...
		world.setBlock(i + 4, j + 3, k + 1, Block.oreGold.blockID);
