...
public class VirtiousHoe extends VirtiousItem
{
    ...
    public VirtiousHoe(int par1, EnumVirtiousToolMaterial par2EnumVirtiousToolMaterial)
    {
        super(par1);
    ...
    /**
     * Returns the name of the material this tool is made from as it is declared in EnumVirtiousToolMaterial (meaning diamond
