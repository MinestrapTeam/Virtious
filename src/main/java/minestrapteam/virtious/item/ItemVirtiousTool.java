...
public class ItemVirtiousTool extends VirtiousItem
{
    ...
    protected EnumVirtiousToolMaterial toolMaterial;

    protected ItemVirtiousTool(int par1, float par2, EnumVirtiousToolMaterial par3EnumVirtiousToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
        this.toolMaterial = par3EnumVirtiousToolMaterial;
