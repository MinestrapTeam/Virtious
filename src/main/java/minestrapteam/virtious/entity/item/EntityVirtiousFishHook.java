...
import minestrapteam.virtious.VirtiousFish;
...
public class EntityVirtiousFishHook extends Entity
{
    ...
    public EntityVirtiousFishHook(World par1World)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    @SideOnly(Side.CLIENT)
    public EntityVirtiousFishHook(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
    {
        this(par1World);
        this.setPosition(par2, par4, par6);
        this.ignoreFrustumCheck = true;
        this.angler = par8EntityPlayer;
        Virtious.fishEntity = this;
    }

    public EntityVirtiousFishHook(World par1World, EntityPlayer par2EntityPlayer)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public int catchFish()
    {
        ...
        else
        {
            ...
            {
                EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, VirtiousFish.getRandomFish());
